	...
	<div class="col">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          ...
          <h3 class="mb-0">컴퓨터 활용 능력</h3>
          <c:forEach items="${course_info}" var="list" begin="8" end="8">
          <div class="mb-1 text-muted">개강일 : <c:out value="${list.start_date}" /></div>
          </c:forEach>
          <p class="card-text mb-auto">현장실무의 응용력을 키워 자격증을 한 번에 취득! 스프레드시트를 실무[엑셀]와 데이터베이스 실무[엑세스]를 이용한 대한상공회의소에서 시행하는 국가기술자격 취득[컴퓨터활용능력 1급] 교육과정입니다.</p>
        </div>
